...
/**
 * Обработчик ручного запуска рассылки вопросов о замене партнёра.
 *
 * @param telegramProperties конфигурации подключения к Telegram
...
class ManualRematchHandler(
    ...
    companion object {
        /** Команда ручного запуска рассылки вопросов о замене партнёра. */
        const val COMMAND = "/send_rematch"
    }
}
